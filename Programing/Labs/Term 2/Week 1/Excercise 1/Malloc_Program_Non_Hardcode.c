...
/* Date: 28/1/14
    ...
    Content: This program will use the malloc() function to Calculate the size of a block of memory required to input a given set of numbers, whereby it will display, "Cannot allocate memory", if it is unable
                  to find space in memory or, "Enter your numbers" if it can. It determines this by casting which forces the number given for maloc() to be represented in int form*/
main()
{
    int *Ptr;
    ...
    No_of_bytes = No_of_elements * sizeof(int);
